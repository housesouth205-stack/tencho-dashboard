...
import { heatColor, heatText, minMax, HEAT5 } from "../../calc/heat.js";
...
export async function mount(host) {
  ...
  function legend() {
    ...
    const sw = HEAT5.map((c) => el("span", { style: `display:inline-block;width:20px;height:12px;background:${c}` }));
    return el("div", { class: "row", style: "align-items:center;gap:6px;margin-bottom:8px;font-size:12px;color:var(--fg-dim)" },
